...
-- 5 
-- Here I got some help from https://www.sqlshack.com/overview-of-sql-rank-functions/
-- I doubt this is the method SQLZoo had in mind but it works.
-- Create a table that is just the table from question 4, and then select
-- the top positions from it (as unfortunately you can't just use a WHERE posn = 1
